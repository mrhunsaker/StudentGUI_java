...
public class ScreenReader extends JPanel {
    ...
    public ScreenReader(String studentName, LocalDate date, JLineGraph lineGraph) {
        ...
        JLabel titleLabel = new JLabel("ScreenReader Skills Progression", JLabel.CENTER);
    ...
    private void initDatabase() {
        ...
        try {
            ...
            String createTableSQL = "CREATE TABLE IF NOT EXISTS screenreader_student_data ("
    ...
    private void submitData(String studentName, LocalDate date) {
        String insertSQL = "INSERT INTO screenreader_student_data ("
                + "studentName, date, "
...
private ResultSet createCustomResultSet(int id, String studentName, String date, int[] skills) {
    ...
    return null;
        ...
        try {
            ...
            Statement stmt = conn.createStatement();
            String selectAllSQL = "SELECT * FROM screenreader_student_data  ORDER BY id DESC LIMIT 5";
            ...
            while (rs.next()) {
                ...
                allSkillValues.add(0, skillValues); // Add to the beginning of the list
            }
