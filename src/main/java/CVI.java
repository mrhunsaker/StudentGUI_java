...
public class CVI extends JPanel {
    ...
    public CVI(String studentName, LocalDate date, JLineGraph lineGraph) {
        ...
        JLabel titleLabel = new JLabel("CVI Skills Progression", JLabel.CENTER);
    ...
    private void initDatabase() {
        ...
        try {
            ...
            String createTableSQL = "CREATE TABLE IF NOT EXISTS cvi_student_data ("
    ...
    private void submitData(String studentName, LocalDate date) {
        String insertSQL = "INSERT INTO cvi_student_data ("
                + "studentName, date, "
...
private ResultSet createCustomResultSet(int id, String studentName, String date, int[] skills) {
    ...
    private void refreshGraph() {
        try {
            ...
            Statement stmt = conn.createStatement();
            String selectAllSQL = "SELECT * FROM cvi_student_data ORDER BY id DESC LIMIT 5";
