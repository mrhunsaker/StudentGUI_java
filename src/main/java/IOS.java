...
public class IOS extends JPanel {
    ...
    public IOS(String studentName, LocalDate date, JLineGraph lineGraph) {
        ...
        JLabel titleLabel = new JLabel("IOS Skills Progression", JLabel.CENTER);
    ...
    private void initDatabase() {
        ...
        try {
            ...
            String createTableSQL = "CREATE TABLE IF NOT EXISTS ios_student_data ("
    ...
    private void submitData(String studentName, LocalDate date) {
        String insertSQL = "INSERT INTO ios_student_data ("
                + "studentName, date, "
...
private ResultSet createCustomResultSet(int id, String studentName, String date, int[] skills) {
    ...
    private void refreshGraph() {
        try {
            ...
            Statement stmt = conn.createStatement();
            String selectAllSQL = "SELECT * FROM ios_student_data ORDER BY id DESC LIMIT 5";
